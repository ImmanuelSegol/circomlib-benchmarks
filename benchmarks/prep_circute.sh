...
node --trace-gc --trace-gc-ignore-scavenger --max-old-space-size=2048000 --initial-old-space-size=2048000 --no-global-gc-scheduling --no-incremental-marking --max-semi-space-size=1024 --initial-heap-size=2048000 --expose-gc "$node_modules"/node_modules/snarkjs/cli.js zkey new ./"$circuit_name".r1cs "$PTAU_FILE" ./"$circuit_name"_0.zkey

echo "~~~GENERATING FINAL ZKEY~~~"
node --trace-gc --trace-gc-ignore-scavenger --max-old-space-size=2048000 --initial-old-space-size=2048000 --no-global-gc-scheduling --no-incremental-marking --max-semi-space-size=1024 --initial-heap-size=2048000 --expose-gc "$node_modules"/node_modules/snarkjs/cli.js zkey beacon ./"$circuit_name"_0.zkey ./"$circuit_name".zkey 0102030405060708090a0b0c0d0e0f101112231415161718221a1b1c1d1e1f 10 -n="Final Beacon phase2"

echo "~~~VERIFYING FINAL ZKEY~~~"
node --trace-gc --trace-gc-ignore-scavenger --max-old-space-size=2048000 --initial-old-space-size=2048000 --no-global-gc-scheduling --no-incremental-marking --max-semi-space-size=1024 --initial-heap-size=2048000 --expose-gc "$node_modules"/node_modules/snarkjs/cli.js zkey verify ./"$circuit_name".r1cs "$PTAU_FILE" ./"$circuit_name".zkey

echo "~~~EXPORTING VERIFICATION KEY~~~"
node --trace-gc --trace-gc-ignore-scavenger --max-old-space-size=2048000 --initial-old-space-size=2048000 --no-global-gc-scheduling --no-incremental-marking --max-semi-space-size=1024 --initial-heap-size=2048000 --expose-gc "$node_modules"/node_modules/snarkjs/cli.js zkey export verificationkey ./"$circuit_name".zkey ./"$circuit_name"_vkey.json
